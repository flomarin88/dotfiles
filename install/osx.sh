...
sudo scutil --set ComputerName "aircall-florian"
sudo scutil --set HostName "aircall-florian"
sudo scutil --set LocalHostName "aircall-florian"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "aircall-florian"
